 ...
 */
@Service
public class XiGuaServiceImpl implements VideoService {
    private static Logger logger = LoggerFactory.getLogger(XiGuaServiceImpl.class);
    ...
    public static void main(String[] args) {
        System.out.println(new XiGuaServiceImpl().parseUrl("https://v.ixigua.com/JrHM5QM/"));
    }
}
